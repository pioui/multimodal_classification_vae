...
from mcvae.models.trento_encoders import EncoderB0, EncoderB2, EncoderB3
...
logging.basicConfig(filename = '/Users/plo026/repos/decision-making-vaes/logs/{}.log'.format(PROJECT_NAME),level=logging.DEBUG)
