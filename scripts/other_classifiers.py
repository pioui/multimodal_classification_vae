...
plt.savefig(f"{images_dir}trento_SVM_test_CONFUSION_MATRIX.png",bbox_inches='tight', pad_inches=0.2, dpi=500)
...
plt.axis('off')
plt.savefig(f"{images_dir}trento_SVM_PREDICTIONS.png",bbox_inches='tight', pad_inches=0, dpi=500)
